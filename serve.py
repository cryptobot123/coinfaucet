...
RECAPTCHA_PUBLIC_KEY = os.environ.get("6LdGm1UUAAAAAFzdksPWSUivX5I45G3Z7q8BoHid")
RECAPTCHA_PRIVATE_KEY = os.environ.get("6LdGm1UUAAAAACik4gZcoFrPGbX-i_NSZhHO6wOW")
...
app.config.update(dict(
    SECRET_KEY=os.environ.get("LOREMED"),
    WTF_CSRF_SECRET_KEY=os.environ.get("LOREMED")
))
csrf.init_app(app)
